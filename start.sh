...
# Start frontend
cd ../frontend
npm run dev -- --port 12009 --host 0.0.0.0 > frontend.log 2>&1 &
echo "Frontend started on port 12009"

echo "IDURAR ERP CRM is now running!"
echo "Backend: https://work-1-hoawaswwbhuszcua.prod-runtime.all-hands.dev:12010/api/"
echo "Frontend: https://work-2-hoawaswwbhuszcua.prod-runtime.all-hands.dev:12009/"
